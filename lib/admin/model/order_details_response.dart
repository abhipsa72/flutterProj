...
String orderDetailsResponseToMap(OrderDetailsResponse data) =>
...
class Success {
  ...
  factory Success.fromMap(Map<String, dynamic> json) => Success(
        order:
            json["order"] == null ? null : OrderDetails.fromMap(json["order"]),
      );
...
class OrderDetails {
  ...
  factory OrderDetails.fromMap(Map<String, dynamic> json) => OrderDetails(
        ...
        customField: json["custom_field"] == null
            ? null
            : List<dynamic>.from(json["custom_field"].map((x) => x)),
        ...
        affiliateFirstname: json["affiliate_firstname"] == null
            ? null
            : json["affiliate_firstname"],
        affiliateLastname: json["affiliate_lastname"] == null
            ? null
            : json["affiliate_lastname"],
  ...
  Map<String, dynamic> toMap() => {
        ...
        "custom_field": customField == null
            ? null
            : List<dynamic>.from(customField.map((x) => x)),
        "payment_firstname": paymentFirstname == null ? null : paymentFirstname,
        ...
        "payment_iso_code_2": paymentIsoCode2 == null ? null : paymentIsoCode2,
        "payment_iso_code_3": paymentIsoCode3 == null ? null : paymentIsoCode3,
        ...
        "shipping_lastname": shippingLastname == null ? null : shippingLastname,
        ...
        "affiliate_firstname":
            affiliateFirstname == null ? null : affiliateFirstname,
        "affiliate_lastname":
            affiliateLastname == null ? null : affiliateLastname,
