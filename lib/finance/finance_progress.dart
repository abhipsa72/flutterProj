...
import 'package:zel_app/finance/finance_progress_details.dart';
import 'package:zel_app/model/product.dart';
import 'package:zel_app/util/ExceptionHandle.dart';

class FinanceProgressCompleted extends StatelessWidget {
  @override
                      ...
                      return ListTile(
                        ...
                        onTap: () async {
                          ...
                          await Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => FinanceProgressDetail(),
                            ),
                          );
                        },
                      );
...
class FinanceProgressWip extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final _provider = Provider.of<FinanceProviderBloc>(context);
    return Scaffold(
