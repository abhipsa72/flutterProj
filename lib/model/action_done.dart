...
List<ActionDone> actionDoneFromJson(List str) => List<ActionDone>.from(str.map((x) => ActionDone.fromMap(x)));

String actionDoneToJson(List<ActionDone> data) => json.encode(List<dynamic>.from(data.map((x) => x.toMap())));
...
class ActionDone {
  ...
  factory ActionDone.fromMap(Map<String, dynamic> json) => ActionDone(
