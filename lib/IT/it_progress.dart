...
import 'package:zel_app/IT/it_progress_detail.dart';
...
class ItProgressWIP extends StatelessWidget {
  @override
                      ...
                      return ListTile(
                        ...
                        onTap: () async {
                          ...
                          await Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => ItProgressDetail(),
                            ),
                          );
                        },
                      );
...
class ItProgressComplete extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final _provider = Provider.of<ItProvider>(context);
    return Scaffold(
